...
export default class World
{
    ...
    CreateWorld(seed: number)
    {
        ...
        // seed is divided by 3, meaning that in any case, it will end up being less than 333, meaning that it will be less than 30 chunks
        // so range is about from 20-53 chunks
        seed /= 3;
